...
// Tailwind themselves. The Tailwind CLI inlines our `@import
// "@fontsource-variable/..."` lines, and the @font-face rules it emits point at
// relative `./files/*.woff2` paths. Without those files present a consumer's
// bundler fails to resolve them and the build dies, so ship them alongside.
...
let copied = 0
for (const font of ["@fontsource-variable/manrope", "@fontsource-variable/dm-sans"]) {
